...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputLayoutName = (TextInputLayout) findViewById(R.id.signup_input_layout_name);
        inputLayoutEmail = (TextInputLayout) findViewById(R.id.signup_input_layout_email);
        inputLayoutPassword = (TextInputLayout) findViewById(R.id.signup_input_layout_password);
